CREATE TABLE [salespropos].[return_purchases] (
    ...
    CONSTRAINT [PK_return_purchases_id] PRIMARY KEY CLUSTERED ([id] ASC)
);


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'salespropos.return_purchases', @level0type = N'SCHEMA', @level0name = N'salespropos', @level1type = N'TABLE', @level1name = N'return_purchases';
